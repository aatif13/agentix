    ...
    <div className="grid-bg" style={{
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 14, marginTop: 8 }}>Sign in to your investor portal</p>
        </div>

        <div className="card" style={{ padding: '32px' }}>
          <h1 style={{ fontSize: 22, fontWeight: 700, marginBottom: 24 }}>Welcome Investor</h1>
